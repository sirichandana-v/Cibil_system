...
include "includes/header.php"; 
	...
	if (isset($_POST['submit'])) {
		...
		if ($query) {
			echo "<script>alert('bank Deleted!')</script>";
		}
	}
...
<div class="container">
	...
	<div class="alert alert-warning col-lg-7 col-md-12 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-0 col-sm-offset-1 col-xs-offset-0" style="margin-top:70px">
	    ...
	    <strong>Banks Table</strong>
	</div>
	<!-- <div class="alert alert-info col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px">
		<button class="btn btn-success" style="float: left"><span class="glyphicon glyphicon-plus-sign"></span> Add Bank</button>
		
	    <form class="form-vertical col-lg-6 col-md-6 col-sm-6 col-xs-12" role="form" style="float: right">
	    	<div class="form-group ">
				<label for="Username" class="col-lg-8 col-md-2 col-xs-8 col-sm-8 control-label">Search Bank</label>
	...
	<div class="container col-lg-11 ">
		<div class="panel panel-default">
		  ...
		  <div class="panel-heading">
		  	<div class="row">
		  	  <a href="addbank.php"><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" style="margin-left: 15px;margin-bottom: 5px"><span class="glyphicon glyphicon-plus-sign"></span> Add bank</button></a>
		  ...
		  <table class="table table-bordered">
		          ...
		          <tbody> 
		            <tr> 
		             ...
		             <td>
		             	<form action="viewbanks.php" method="post">
		             	<input type="hidden" value="<?php echo $row['bank_Id']; ?>" name="del_btn">
