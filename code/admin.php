...
<div class="container">
	...
	<div class="container">
        ...
        <div class="alert alert-success alert-dismissable">
		  ...
		  <div class="panel-heading">
		  	<div class="row">
		  		<h3 class="center-block">Update Blacklist</h3>
			</div>
		  </div>
	...
	<td><?php echo $row['loanid']; ?></td>
     ...
     <?php }
           ?>
			...
			<div class="panel panel-default">
				  <div class="panel-heading">
				    <h2 class="panel-title center-block">Update Blacklist</h2>
				  </div>
	  <div class="panel-body">
	    <form role="form" action="admin.php" method="post">
				<div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
						 <div class="form-group ">
					      <label for="name">loanId</label>
					       <textarea class="form-control" rows="1" draggable="false" name="loanid">
					       </textarea>
					  </div>
        	...
        	<div class="modal-dialog">
        		<div class="modal-content">
        			...
        			<div class="modal-body">
							...
							<div class="form-group ">
        						      <label for="name">loanId</label>
        						       <textbox class="form-control" rows="1" draggable="false" name="text" value="
									    ">
        						       <textbox>
        						  </div>
								 <div class="form-group ">
  ...
  <script type="text/javascript">
        ...
        function Delete() {
            return confirm('Would you like to delete the blacklist');
        }

         function Update() {
            return confirm('Would you like to update the blacklist');
        }
