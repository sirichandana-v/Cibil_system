		         ...
		         <tr> <th>INDEX</th>
					...
					$counter = 1;
						while($row = mysqli_fetch_array($query)){
							$_SESSION['book_Title'] = $row['username'];
							...
							<input type="hidden" class="book-id" value="<?php echo $row['loanId']; ?>">
							<input type="hidden" class="book-name" value="<?php echo $row['username']; ?>">
